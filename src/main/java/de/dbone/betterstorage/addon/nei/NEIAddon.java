package de.dbone.betterstorage.addon.nei;
/*
...
public class NEIAddon extends Addon {
	...
	public void postInitialize() {	
		...
		API.registerGuiOverlayHandler(GuiCraftingStation.class, new StationOverlayHandler(), Constants.modId + ".craftingStation");
