package de.dbone.betterstorage.container;
...
public class ContainerCraftingStation extends ContainerBetterStorage {
	...
	protected void setupInventoryContainer() {
		inv = ((inventory instanceof InventoryCraftingStation) ? (InventoryCraftingStation)inventory : ((InventoryCraftingStation)((InventoryTileEntity)inventory).inventory));
	...
	public boolean canMergeSlot(ItemStack stack, Slot slot) {
		return (super.canMergeSlot(stack, slot) && ((slot.slotNumber < 9) || (slot.slotNumber >= 18)));
	}
}
