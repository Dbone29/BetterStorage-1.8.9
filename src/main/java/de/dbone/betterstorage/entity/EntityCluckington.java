package de.dbone.betterstorage.entity;
...
public class EntityCluckington extends EntityChicken {
	...
	public EntityCluckington(World world) {
		super(world);
        setSize(0.6F, 0.8F);
		EntityAITaskEntry panic  = tasks.taskEntries.get(1);
		EntityAITaskEntry mate   = tasks.taskEntries.get(2);
		EntityAITaskEntry tempt  = tasks.taskEntries.get(3);
		EntityAITaskEntry follow = tasks.taskEntries.get(4);
