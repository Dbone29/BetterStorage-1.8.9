...
import de.dbone.betterstorage.client.model.ModelDrinkingHelmet;
...
import de.dbone.betterstorage.misc.SmallPotionEffect;
...
public class ItemDrinkingHelmet extends ItemArmorBetterStorage {
	...
	public static final ArmorMaterial material = EnumHelper.addArmorMaterial("drinkingHelmet", "Error?", 11, new int[]{ 3, 0, 0, 0 }, 15);
