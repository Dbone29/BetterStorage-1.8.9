...
public abstract class ConnectedTexture {
	...
	public IIcon getConnectedIcon(IBlockAccess world, int x, int y, int z, EnumFacing side) {
		boolean top    = canConnect(world, x, y, z, side, EnumFacing.getOrientation(connectedLookup[side.ordinal()][0]));
		boolean bottom = canConnect(world, x, y, z, side, EnumFacing.getOrientation(connectedLookup[side.ordinal()][1]));
		boolean left   = canConnect(world, x, y, z, side, EnumFacing.getOrientation(connectedLookup[side.ordinal()][2]));
		boolean right  = canConnect(world, x, y, z, side, EnumFacing.getOrientation(connectedLookup[side.ordinal()][3]));
	...
	public abstract boolean canConnect(IBlockAccess world, int x, int y, int z, EnumFacing side, EnumFacing connected);
