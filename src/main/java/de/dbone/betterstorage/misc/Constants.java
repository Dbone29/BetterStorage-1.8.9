...
public final class Constants {
	...
	public static final String commonProxy = "de.dbone.betterstorage.proxy.CommonProxy";
	public static final String clientProxy = "de.dbone.betterstorage.proxy.ClientProxy";
