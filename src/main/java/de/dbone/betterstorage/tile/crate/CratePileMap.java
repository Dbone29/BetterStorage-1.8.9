...
import de.dbone.betterstorage.misc.Region;
...
public class CratePileMap {
	...
	public void add(TileEntity entity) {
		set(entity.getPos().getX(), entity.getPos().getY(), entity.getPos().getZ(), true);
	}
	public void remove(TileEntity entity) {
		set(entity.getPos().getX(), entity.getPos().getY(), entity.getPos().getZ(), false);
	}
