...
public abstract class TileEntityContainer extends TileEntity {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (!canPlayerUseContainer(playerIn)) return true;
	...
	public void openGui(EntityPlayer playerIn, World worldIn, BlockPos pos) {
		ContainerBetterStorage container = createContainer(playerIn);
	}
	...
	protected int getStrongRedstoneSignal() { return 0; } //return worldObj.getBlockPowerInput(pos.getX(), pos.getY(), pos.getZ()); }
	/** Returns the weak redstone signal power going into this block. */
	protected int getWeakRedstoneSignal() { return 0; } //return worldObj.getStrongestIndirectPower(xCoord, yCoord, zCoord); }
	...
	public static int getContainerComparatorSignalStrength(IBlockAccess world, int x, int y, int z) {
		TileEntityContainer container = WorldUtils.get(world, new BlockPos(x, y, z), TileEntityContainer.class);
	...
	protected boolean syncPlayersUsing() {
		return (!worldObj.isRemote && doesSyncPlayers() &&
		        ...
		        //worldObj.doChunksNearChunkExist(pos.getX(), pos.getY(), pos.getZ(), 16));
	}
